...
//  Pierpont1
//
//  Created by Andrew Drogalis on 4/1/22.
//
...
class PDFCreator: NSObject {
    // PDF Creator Work Order
    let title: String
    let DescriptionWork: String
    let RecommendationText: String
    let body: String
    let image: UIImage
    let contactInfo: String
    
    init(title: String, DescriptionWork: String, RecommendationText: String, body: String, image: UIImage, contact: String) {
    ...
    func createFlyer() -> Data {
      ...
      let pdfMetaData = [
        ...
        kCGPDFContextAuthor: "pierpontmech.com",
